...
* [Что такое JavaScript](fundamentals-and-variables/chto-takoe-javascript.md)
* [Что такое глобальный объект (global object) в JavaScript?](fundamentals-and-variables/chto-takoe-globalnyi-obekt-global-object-v-javascript.md)
* [Какие логические операторы есть в JavaScript и какой результат они возвращают?](fundamentals-and-variables/kakie-logicheskie-operatory-est-v-javascript-i-kakoi-rezultat-oni-vozvrashayut.md)
* [What are the differences between var, let, and const?](fundamentals-and-variables/what-are-the-differences-between-var-let-and-const.md)
* [Какие виды циклов в JavaScript вы знаете? В каких случаях лучше использовать каждый из них?](fundamentals-and-variables/kakie-vidy-ciklov-v-javascript-vy-znaete-v-kakikh-sluchayakh-luchshe-ispolzovat-kazhdyi-iz-nikh.md)
* [Что такое рекурсия (recursion)? Что такое стек (stack)?](fundamentals-and-variables/chto-takoe-rekursiya-recursion-chto-takoe-stek-stack.md)

## Типы и приведение типов (Types & Coercion)

* [В чем разница между null, undefined и необъявленной переменной (undeclared variable)?](tipy-i-privedenie-tipov-types-and-coercion/v-chem-raznica-mezhdu-null-undefined-i-neobyavlennoi-peremennoi-undeclared-variable.md)
* [В чем разница между == и === в JavaScript?](tipy-i-privedenie-tipov-types-and-coercion/v-chem-raznica-mezhdu-i-v-javascript.md)
* [Что такое приведение типов (type coercion) и можете ли вы привести примеры, когда оно приводит к неожиданным результатам?](tipy-i-privedenie-tipov-types-and-coercion/chto-takoe-privedenie-tipov-type-coercion-i-mozhete-li-vy-privesti-primery-kogda-ono-privodit-k-neo.md)
* [Какие значения в JavaScript являются "ложными" (falsy values)?](tipy-i-privedenie-tipov-types-and-coercion/kakie-znacheniya-v-javascript-yavlyayutsya-lozhnymi-falsy-values.md)
* [Какие типы данных есть в JavaScript? Как проверить тип переменной?](tipy-i-privedenie-tipov-types-and-coercion/kakie-tipy-dannykh-est-v-javascript-kak-proverit-tip-peremennoi.md)
* [Назовите несколько способов округления числа в JavaScript.](tipy-i-privedenie-tipov-types-and-coercion/nazovite-neskolko-sposobov-okrugleniya-chisla-v-javascript..md)
* [Как преобразовать число в строку и наоборот? Когда такое преобразование может пригодиться?](tipy-i-privedenie-tipov-types-and-coercion/kak-preobrazovat-chislo-v-stroku-i-naoborot-kogda-takoe-preobrazovanie-mozhet-prigoditsya.md)

## Scope, Hoisting & Closures

* [Что такое поднятие (hoisting) и чем оно отличается для var, let, const и объявлений функций (function declarations)?](scope-hoisting-and-closures/chto-takoe-podnyatie-hoisting.md)
* [Что такое область видимости (scope) и что такое лексическая область видимости (lexical scope) в JavaScript?](scope-hoisting-and-closures/chto-takoe-oblast-vidimosti-i-lexical-scope.md)
* [Что такое замыкание (closure) и в каких случаях вы бы его использовали?](scope-hoisting-and-closures/chto-takoe-zamykanie-closure.md)
* [Как создавать приватные (private) переменные в JavaScript?](scope-hoisting-and-closures/kak-sozdavat-private-peremennye-v-javascript.md)
...
* [Чем стрелочные функции (arrow functions) отличаются от обычных функций?](this-and-functions/chem-strelochnye-funkcii-arrow-functions-otlichayutsya-ot-obychnykh-funkcii.md)
* [В чем разница между объявлением функции (function declaration) и функциональным выражением (function expression)?](this-and-functions/v-chem-raznica-mezhdu-obyavleniem-funkcii-function-declaration-i-funkcionalnym-vyrazheniem-function.md)
* [Почему функции в JavaScript называют "объектами первого класса" (first-class citizens)?](this-and-functions/pochemu-funkcii-v-javascript-nazyvayut-obektami-pervogo-klassa-first-class-citizens.md)
* [Что такое функция высшего порядка (higher-order function)?](this-and-functions/chto-takoe-funkciya-vysshego-poryadka-higher-order-function.md)
* [Что такое IIFE (немедленно вызываемое функциональное выражение) и зачем его использовать?](this-and-functions/chto-takoe-iife-nemedlenno-vyzyvaemoe-funkcionalnoe-vyrazhenie-i-zachem-ego-ispolzovat.md)
* [В чем разница между методами call(), apply() и bind()?](this-and-functions/v-chem-raznica-mezhdu-metodami-call-apply-i-bind.md)
...
* [Как удалить пробелы в начале и конце строки (`trim`, `trimStart`, `trimEnd`)? Как дополнить строку до заданной длины (`padStart`, `padEnd`)?](strings/probely-udalenie-simvolov.md)
